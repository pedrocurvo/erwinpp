...
from erwin.experiments.datasets.plas import PlasDataset
from erwin.experiments.wrappers import PlasModel
...
def parse_args():
    ...
    parser.add_argument("--experiment", type=str, default="plas", 
...
if __name__ == "__main__":
    ...
    train_dataset = PlasDataset(
        data_path=args.data_path,
        split="train",
        knn=args.knn,
    )

    valid_dataset = PlasDataset(
        data_path=args.data_path,
        split="test",
        knn=args.knn,
    )

    test_dataset = PlasDataset(
        data_path=args.data_path,
        split="test",
        knn=args.knn,
    )
    ...
    model = PlasModel(main_model).cuda()
