...
from erwin.experiments.datasets.pipe import PipeDataset
from erwin.experiments.wrappers import PipeModel
...
def parse_args():
    ...
    parser.add_argument("--experiment", type=str, default="pipe", 
...
if __name__ == "__main__":
    ...
    model = PipeModel(main_model).cuda()
